                ...
                <div className="row">
                    <div className="col-md-4 text-center my-2">
                        ...
                        <div id="carouselExampleControls1" className="carousel slide my-1" data-bs-ride="carousel">
                            <div className="carousel-inner">
                                ...
                                <img src="./portfolio-master/portfolio-images/w-01.png" className="d-block w-100" alt="..."/>
                                </div>
                                <div className="carousel-item">
                                <img src="./portfolio-master/portfolio-images/w-02.png" className="d-block w-100" alt="..."/>
                                </div>
                                <div className="carousel-item">
                                <img src="./portfolio-master/portfolio-images/w-03.png" className="d-block w-100" alt="..."/>
                                </div>
                            </div>
                    ...
                    <div className="col-md-4 text-center my-2">
                        ...
                        <div id="carouselExampleControls2" className="carousel slide my-1" data-bs-ride="carousel">
                            <div className="carousel-inner">
                                <div className="carousel-item active">
                                <img src="./portfolio-master/portfolio-images/m-01.png" className="d-block w-100" alt="..."/>
                                </div>
                                <div className="carousel-item">
                                <img src="./portfolio-master/portfolio-images/m-02.png" className="d-block w-100" alt="..."/>
                                </div>
                                <div className="carousel-item">
                                <img src="./portfolio-master/portfolio-images/m-03.png" className="d-block w-100" alt="..."/>
                                </div>
                            </div>
                    ...
                    <div className="col-md-4 text-center my-2">
                        ...
                        <div id="carouselExampleControls3" className="carousel slide my-1" data-bs-ride="carousel">
                            <div className="carousel-inner">
                                <div className="carousel-item active">
                                <img src="./portfolio-master/portfolio-images/n-01.png" className="d-block w-100" alt="..."/>
                                </div>
                                <div className="carousel-item">
                                <img src="./portfolio-master/portfolio-images/n-02.png" className="d-block w-100" alt="..."/>
                                </div>
                                <div className="carousel-item">
                                <img src="./portfolio-master/portfolio-images/n-03.png" className="d-block w-100" alt="..."/>
                                </div>
                                <div className="carousel-item">
                                <img src="./portfolio-master/portfolio-images/n-04.png" className="d-block w-100" alt="..."/>
                                </div>
                            </div>
                    ...
                    <div className="col-md-4 text-center my-2">
                        ...
                        <div id="carouselExampleControls4" className="carousel slide my-1" data-bs-ride="carousel">
                            <div className="carousel-inner">
                                <div className="carousel-item active">
                                <img src="./portfolio-master/portfolio-images/solo-01.png" className="d-block w-100" alt="..."/>
                                </div>
                                <div className="carousel-item">
                                <img src="./portfolio-master/portfolio-images/solo-02.png" className="d-block w-100" alt="..."/>
                                </div>
                                <div className="carousel-item">
                                <img src="./portfolio-master/portfolio-images/solo-03.png" className="d-block w-100" alt="..."/>
                                </div>
                                <div className="carousel-item">
                                <img src="./portfolio-master/portfolio-images/solo-04.png" className="d-block w-100" alt="..."/>
                                </div>
                            </div>
                    ...
                    <div className="col-md-4 text-center my-2">
                        ...
                        <div id="carouselExampleControls5" className="carousel slide my-1" data-bs-ride="carousel">
                            <div className="carousel-inner">
                                <div className="carousel-item active">
                                <img src="./portfolio-master/portfolio-images/resume-1.jpg" className="d-block w-100" alt="..."/>
                                </div>
                                <div className="carousel-item">
                                <img src="./portfolio-master/portfolio-images/resume-2.jpg" className="d-block w-100" alt="..."/>
                                </div>
                                <div className="carousel-item">
                                <img src="./portfolio-master/portfolio-images/resume-3.jpg" className="d-block w-100" alt="..."/>
                                </div>
                                <div className="carousel-item">
                                <img src="./portfolio-master/portfolio-images/resume-4.jpg" className="d-block w-100" alt="..."/>
                                </div>
                            </div>
                    ...
                    <div className="col-md-4 text-center my-2">
                        ...
                        <div id="carouselExampleControls6" className="carousel slide my-1" data-bs-ride="carousel">
                            <div className="carousel-inner">
                                <div className="carousel-item active">
                                <img src="./portfolio-master/portfolio-images/tour-01.png" className="d-block w-100" alt="..."/>
                                </div>
                                <div className="carousel-item">
                                <img src="./portfolio-master/portfolio-images/tour-02.png" className="d-block w-100" alt="..."/>
                                </div>
                                <div className="carousel-item">
                                <img src="./portfolio-master/portfolio-images/tour-03.jpg" className="d-block w-100" alt="..."/>
                                </div>
                                <div className="carousel-item">
                                <img src="./portfolio-master/portfolio-images/tour-04.jpg" className="d-block w-100" alt="..."/>
                                </div>
                                <div className="carousel-item">
                                <img src="./portfolio-master/portfolio-images/tour-05.jpg" className="d-block w-100" alt="..."/>
                                </div>
                            </div>
