                ...
                <div className="p-4 bg-dark slide-in-top">
                    ...
                    <div className="row">
                        <div className="col-md-6">
                            ...
                            <ul>
                                <li>
                                    <h4 className="ff-jose my-1 text-red">Junior Analyst Programmer</h4>
                                    <h6 className="blue-label px-2 py-1">May 2022 - Till today</h6>
                                    <p className="m-0">Web Synergies India Pvt Ltd · Full-time</p>
                                    <p>Hyderabad, Telangana, India</p>
                                </li>
                                <li>
                                    <h4 className="ff-jose my-1 text-red">Trainee Analyst Programmer</h4>
                        ...
                        <div className="col-md-6">
                            ...
                            <ul>
                                <li>
                                    <h4 className="ff-jose my-1 text-red">M.Sc. Computer Science</h4>
                                    <h6 className="blue-label px-2 py-1">2019 - 2021</h6>
                                    <p className="m-0">P.A.H. Solapur University</p>
                                    <p>CGPA: 8.05</p>
                                </li>
                                <li>
                                    <h4 className="ff-jose my-1 text-red">B.Sc. Computer Science</h4>
                    ...
                    <div className="row">
                        <div className="col-md-6">
                            ...
                            <h1>
                                <a href="https://www.linkedin.com/in/mukesh-mhanta-844b98147/" target="/blank" className="text-white text-decoration-none mx-2">
                                    <SiLinkedin className="zoom-on-hover" />
                                </a>
                                <a href="https://www.hackerrank.com/mukeshmhanta4" target="/blank" className="text-white text-decoration-none mx-2">
